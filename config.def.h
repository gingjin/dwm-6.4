...
static const char *fonts[]          = { "LXGW WenKai:size=12", "Firacode Nerd Font Mono:size=16" };
static const char dmenufont[]       = "LXGW WenKai:size=12";
...
static const char *colors[][4]      = {
	...
	[SchemeTitle]  = { col_gray4, col_cyan,  col_cyan, NULL  },
};
